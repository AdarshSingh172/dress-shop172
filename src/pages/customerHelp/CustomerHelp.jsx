...
export const CustomerHelp = () => {
  return (
    <div style={{ margin: '2rem' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: '3rem', fontSize: '1.1rem', fontWeight: 'lighter' }}>For Help : <span style={{ color: 'lightseagreen', fontWeight: 'bold' }}>6392-6233-39</span></div>
      <Module />
    </div>
  )
}
